...
<div class="col-lg-6">
    ...
    <li><a href="<?php echo admin_url('category')?>"><button type="button" class="btn btn-primary">Quay lại <span class="btn-icon-right"><i class="fa fa-arrow-left color-info"></i></span></button></a></li>
</div>
<br>
            ...
            <div class="basic-form">
                <form method="POST" enctype="multipart/form-data" action="" class="form-input">
                    ...
                    <div class="form-group row align-items-center">
                        <label class="col-sm-2 col-form-label text-label">Tên</label>
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input type="text" class="form-control" id="name_add" name="name" value="<?php echo $category->name?>">
                            </div>
                        </div>
                        <div class="col-sm-2">
