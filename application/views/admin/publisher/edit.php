...
<div class="col-lg-6">
    ...
    <li><a href="<?php echo admin_url('publisher')?>"><button type="button" class="btn btn-primary">Quay lại <span class="btn-icon-right"><i class="fa fa-arrow-left color-info"></i></span></button></a></li>
</div>
<br>
    <div class="card forms-card">
        <div class="card-body">
            <h4 class="card-title mb-4">Sửa nhà sản xuất</h4>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" id="name_edit" name="name" value="<?php echo $publisher->name?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" id="email_edit" name="email" value="<?php echo $publisher->email?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" id="phone_edit" name="phone" value="<?php echo $publisher->phone?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" id="address_edit" name="address" value="<?php echo $publisher->address?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
