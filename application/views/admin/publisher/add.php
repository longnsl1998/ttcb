...
<br>
    <div class="card forms-card">
        <div class="card-body">
            <h4 class="card-title mb-4">Form thêm thể loại</h4>
                ...
                <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" id="name_edit" name="name" value="">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" id="email_edit" name="email" value="">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
