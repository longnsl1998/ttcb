            ...
            <div class="basic-form">
                <form method="POST" enctype="multipart/form-data" action="" class="form-input">
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" id="code_add" name="code" value="">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="number" class="form-control" id="money_add" name="money" value="">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="number" class="form-control" id="money_add" name="qty" value="">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        <label class="col-sm-3 col-form-label text-label">Require Price</label>
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="number" class="form-control" id="money_add" name="require_price" value="">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="datetime-local" class="form-control" id="money_add" name="start" value="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="datetime-local" class="form-control" id="money_add" name="end" value="">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
